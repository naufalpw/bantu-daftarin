...
class ApplicationStatusTest extends TestCase
{
    ...
    {
        $expected = [
            ApplicationStatus::DRAFT->value => [ApplicationStatus::AWAITING_DOCUMENTS->value],
            ApplicationStatus::AWAITING_DOCUMENTS->value => [ApplicationStatus::DOCUMENTS_READY_FOR_PAYMENT->value],
            ApplicationStatus::DOCUMENTS_READY_FOR_PAYMENT->value => [ApplicationStatus::AWAITING_PAYMENT->value],
            ApplicationStatus::AWAITING_PAYMENT->value => [ApplicationStatus::PAYMENT_CONFIRMED->value],
