...
enum BusinessType: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::EVENT_ORGANIZER => 'Penyelenggara Kegiatan',
            ...
            self::COLLECTIVE_INVESTMENT_CONTRACT => 'Kontrak Investasi Kolektif',
            self::SOCIAL_POLITICAL_ORGANIZATION => 'Organisasi Sosial Politik',
            self::LIMITED_PARTNERSHIP => 'Perseroan Komanditer (CV)',
            self::FOUNDATION => 'Yayasan',
            self::FIRMA => 'Firma',
            self::COOPERATIVE_INVESTMENT_CONTRACT => 'Kontrak Investasi Koperasi',
